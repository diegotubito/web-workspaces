...
import { useInstallmentSaleMapping } from '../useInstallmentSaleMapping';

export const SaleOrderInstallmentComponent = ({ initialOrder, onSelectedInstallment, onInstallmentError, onPayemntDidClicked, setIsLoading }) => {
   const { t } = useTranslation()

   const { getInstallments, installments, onInstallmentFailed, isLoading } = useInstallmentViewModel()
   const { mapInstallments } = useInstallmentSaleMapping()
